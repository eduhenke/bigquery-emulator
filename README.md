...
[![build and test](https://github.com/eduhenke/bigquery-emulator/actions/workflows/test.yml/badge.svg)](https://github.com/eduhenke/bigquery-emulator/actions/workflows/test.yml)
[![GoDoc](https://godoc.org/github.com/eduhenke/bigquery-emulator?status.svg)](https://pkg.go.dev/github.com/eduhenke/bigquery-emulator?tab=doc)
...
```console
$ go install github.com/eduhenke/bigquery-emulator/cmd/bigquery-emulator@latest
```
...
```console
$ docker pull ghcr.io/eduhenke/bigquery-emulator:latest
```

You can also download the darwin(amd64) and linux(amd64) binaries directly from [releases](https://github.com/eduhenke/bigquery-emulator/releases)
...
```console
$ docker run -it ghcr.io/eduhenke/bigquery-emulator:latest --project=test
```
...
* `server/testdata/data.yaml` is [here](https://github.com/eduhenke/bigquery-emulator/blob/main/server/testdata/data.yaml)
...
Please imports `github.com/eduhenke/bigquery-emulator/server` ( and `github.com/eduhenke/bigquery-emulator/types` ) and you can use `server.New` API to create the emulator server instance.

See the API reference for more information: https://pkg.go.dev/github.com/eduhenke/bigquery-emulator
